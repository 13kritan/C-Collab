        ...
        <>
            <div className="space-y-6">
                <div>
                    ...
                    <p className="text-sm text-slate-500">Log in to access your workspace</p>
                </div>
                ...
                <span className="text-xs text-slate-500 cursor-pointer hover:text-white transition-colors">Forgot Password?</span>
                {/* Login Button */}
                ...
                <p className="text-center text-sm text-slate-500 mt-4">
                    Don't have an account? <span onClick={() => setIsLogin(false)} className="text-[#3B82F6] cursor-pointer hover:underline">Sign Up</span>
                </p>
            </div>
        </>
    )
